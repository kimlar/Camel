...
WindowGlass::WindowGlass(Camera* camera)
{
	this->camera = camera;
}
...
void WindowGlass::Create(glm::vec3 position)
{
	...
	Texture = loadDDS("clear-glass.dds");
	...
	// Read our .obj file
	//bool res = loadOBJ("window-cube.obj", vertices, uvs, normals);
	bool res = loadOBJ("window-glass.obj", vertices, uvs, normals);
...
void WindowGlass::Render()
{

	//Make sure to turn back-face culling off
